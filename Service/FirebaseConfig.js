// // Updated FirebaseConfig.js - Added login function, profile functions, and exports
...
//   query,
//   where,
//   limit, // Added: Import for query limiting
//   getDocs,
//   collection,
//   addDoc,
//   updateDoc,
...
// // Listening to Messages for Admins (Team + Private Sent)
// function listenToAdminMessages(adminUid, teamCallback, privateSentCallback) {
//   // Listen to team messages
//   if (teamCallback) {
...
//   // Listen to private messages sent by admin
//   if (privateSentCallback) {
//     const privateQuery = query(
//       collection(db, "privateMessages"),
...
//   saveUserProfile,
// };
// Updated FirebaseConfig.js - Fixed listenToAdminMessages to include sent and received private messages for full conversations
import { initializeApp } from "firebase/app";
import { getAnalytics } from "firebase/analytics";
import {
  getAuth,
