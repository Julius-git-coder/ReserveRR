// // Complete fixed Administrator.jsx
      ...
      <div className="bg-gray-800 w-full h-full max-w-4xl rounded-lg flex flex-col">
        ...
        <div className="bg-gray-700 p-4 flex items-center justify-between border-b border-gray-600">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-white font-semibold">{otherUserProfile?.name || otherUser.name}</h3>
              <p className="text-gray-400 text-sm">{otherUserProfile?.role || otherUser.role}</p>
            </div>
          </div>
          <button onClick={onClose} className="text-gray-400 hover:text-white">
            <X className="w-6 h-6" />
