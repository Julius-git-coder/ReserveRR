// // Updated Components/Administrator.jsx - Added Student Count, Team Messaging, Private Messaging
...
//     const unsubscribe = listenToAdminMessages(
//       adminUid,
//       (messages) => {
...
//     e.preventDefault();
//     if (message.trim()) {
//       await sendTeamMessage(adminUid, message);
//       setMessage("");
//     }
//   };
...
//                 {msg.message} - {msg.timestamp?.toDate().toLocaleString()}
//               </div>
//             ))}
//         </div>
//       </div>
...
//     // Listen to private messages sent
...
//     ? privateMessages.filter((msg) => msg.receiverUid === selectedStudent.uid)
//     : [];
...
//   // Get current user UID from auth (assuming it's available)
...
// Updated Components/Administrator.jsx - Fixed PrivateMessaging to filter full conversations (sent + received) and ensure messages display correctly
import React, { useState, useEffect, useMemo } from "react";
import {
  Users,
  BookOpen,
