...
const AdminSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.teamId.length < 3) {
      setError("Team ID must be at least 3 characters long");
      setIsLoading(false);
      return;
    }
    ...
    try {
      const signupData = {
        ...
        profileImage: null, // Can be updated later via profile
      };
        ...
        <div className="w-full">
          <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-2xl">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-400">
                Choose a unique Team ID that students will use to join your team
              </p>
            </div>
            {error && (
