// Updated AdminSignUp.jsx - Integrated Firebase Signup
...
import { adminSignup } from "../Service/FirebaseConfig";
...
const AdminSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await adminSignup(formData.email, formData.password, formData.teamId);
      console.log("Admin signed up successfully");
      navigate("/Administrator"); // Redirect on success
    } catch (err) {
