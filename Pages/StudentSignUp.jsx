// Updated StudentSignUp.jsx - Integrated Firebase Signup
...
import { studentSignup } from "../Service/FirebaseConfig";
...
const StudentSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await studentSignup(formData.email, formData.password, formData.teamId);
